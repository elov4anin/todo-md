...
import { detectFolder, detectKind, extractTitle, fileId, makeRelativePath, parseFrontMatter, parseSimpleYaml, removeBom, valueOrNull, } from "./parser.js";
export function extractRecord(file, cwd) {
    let content;
    try {
